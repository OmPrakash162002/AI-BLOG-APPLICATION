...
const BlogCard = ({blog}) => {
  ...
  return (
    <div className='w-full rounded-2xl overflow-hidden shadow hover:scale-102 hover:shadow-black duration-300 cursor-pointer border border-white/50  bg-gradient-to-tr from-white/40 to-white/10' onClick={()=>navigate(`/blog/${_id}`)}>
